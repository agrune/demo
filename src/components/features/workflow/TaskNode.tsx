...
export function TaskNode({ data }: NodeProps<Node<WorkflowNodeData>>) {
  return (
    <div className="rounded-md border border-dashed border-muted-foreground/40 bg-muted/50 px-4 py-3 shadow-sm min-w-[110px]">
